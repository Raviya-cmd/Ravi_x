...
const octokit = new Octokit({ auth: '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' });// ඔයා 𝚐𝚒𝚝𝚑𝚞𝚋 𝚝𝚘𝚔𝚎𝚗 එකක් අරන් ඒක දාන්න
const owner = 'Raviya-cmd';//𝚐𝚒𝚝𝚑𝚞𝚋 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 එකේ 𝚞𝚜𝚎𝚗𝚊𝚖𝚎 දාන්න 
const repo = 'Ravi_x';//𝚐𝚒𝚝𝚑𝚞𝚋 𝚛𝚎𝚙𝚘 එකක් හදලා ඒකේ නම දාන්න
...
`;
                    ...
                    sections: [
                        {
                            ...
                            rows: [
                                {
                                    title: 'MENU 📌',
                                    description: 'RAVIYA-MD MINI BOT',
                                    id: `${config.PREFIX}menu`,
                                },
                                {
                                    title: 'OWNER 📌',
                                    description: 'POWERD BY DTZ RAVIYA',
    ...
    await socket.sendMessage(m.chat, {
        ...
        headerType: 1,
        viewOnce: true,
        image: { url: "https://i.ibb.co/v6n843w5/1141.jpg" },
        caption: `RAVIYA-MD ALIVE NOW💥\n\n${captionText}`,
    }, { quoted: msg });
...
`;
    ...
    await socket.sendMessage(m.chat, {
        ...
        headerType: 1,
        viewOnce: true,
        image: { url: "https://i.ibb.co/8D4TFpqC/Supunmd.jpg" },
        caption: `RAVIYA LIST MENU\n\n${captionText}`,
    }, { quoted: msg });
    ...
    const ownerName = 'DTZ RAVIYA';
    const organization = '*RAVIYA-MD* WHATSAPP BOT DEVALOPER 🍬';
  ...
  break;
    ...
    break;
                ...
                case 'ai': {
                    ...
                    if (!q || q.trim() === '') {
                        return await socket.sendMessage(sender, { text: "ඕ කියන්න අනේ් මම RAVIYA-MD AI 🤭" }, { quoted: msg });
                    }

                    const prompt = `ඔබගේ නම RAVIYA AI.  
...
process.on('uncaughtException', (err) => {
    ...
    exec(`pm2 restart ${process.env.PM2_NAME || 'RAVIYA-MINI-main'}`);
});
